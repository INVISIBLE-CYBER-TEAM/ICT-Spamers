#!/usr/bin/env php
#Dilarang copyright coded Ivisible Cyber Team 2018 15 08 12:30
<?php
...
echo $R."\n::#:Facebook ::[Author:or:INVISIBLE CYBER TEAM:]           #";
echo $G."\n::#:YouTube  ::[MAU BUAT DULU KETOD :V :]                  #";
echo $GG."\n::#:Whatsapp ::[0857 8129 1915]                           #";
echo $YY."\n::#: Note:"Pakai dengan bijak ya tod and no recode ya :v  #";                                           #";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		echo "[]ICT Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
while(1) {
foreach($argv[1] as $argv[2]):
echo "[]ICT Sending Massage To[] # ".$G.$argv[2].$X."\n";
